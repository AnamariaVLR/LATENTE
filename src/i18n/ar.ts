...
const ar: Dictionary = {
  ...
  opening: {
    body: 'نختار ونطوّر ونضع القهوة الكولومبية المختصة، بوصفها ثقافة وهوية وطقساً.',
  },

  essence: {
    eyebrow: 'الجوهر',
    body: 'مزروعة بعناية ومحمّصة بدقة، تكشف قهوة LATENTE عن طاقة متّزنة وعمق متعدّد الطبقات — مصمّمة للطقس الهادئ وللاستمتاع الرفيع على حدّ سواء.',
  },
  ...
  hospitality: {
    body: 'مصمّمة لتسكن المساحات الرفيعة. يُكيَّف كل إصدار مع أجواء بيئته وهويتها.',
