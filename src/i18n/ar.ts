...
const ar: Dictionary = {
  ...
  insights: {
    eyebrow: 'ملاحظات ميدانية',
    note: 'ملاحظة',
    title: 'الدقة وراء الفنجان',
    intro:
      'كل شهر، ملاحظة واحدة مقيسة من الزراعة أو المعالجة أو الانتقاء — الأرقام التي تفصل القهوة الجيدة عن الاستثنائية.',
    monthly: 'ملاحظة جديدة كل شهر',
    readMore: 'اقرأ ملاحظة هذا الشهر',
    archive: 'جميع الملاحظات الميدانية',
    metaTitle: 'ملاحظات ميدانية — LATENTE',
    metaDescription:
      'ملاحظات شهرية قائمة على البيانات حول الدقة وراء زراعة القهوة الرفيعة ومعالجتها وانتقائها.',
    archiveTitle: 'ملاحظات ميدانية',
    archiveIntro:
      'سجل شهري للقياسات والقرارات وراء قهوات LATENTE — الزراعة والمعالجة والانتقاء بالأرقام.',
    sources: 'المراجع',
  },
